...
Now we're clear about the enemy -- low acceptance ratio, which lead to biased result. Someone had a crazy idea about how to solve the problem: back to equation \eqref{eqn:transprob}, the low ratio came from the low probability of finding a good target to get high $$p(q_1)/p(q_0)$$. How about making a chain with 100% acceptance probability?
